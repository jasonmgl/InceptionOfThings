...
* [P1: Build a 2-node K3s cluster with Vagrant](./p1/README_EN.md)
* [P2: Deploy apps with Kubernetes manifests](./p2/README_EN.md)
* [P3: Use K3d and Argo CD for continuous deployment](./p3/README_EN.md)
* [Bonus: Local GitLab, Argo CD, and Helm on K3d](./bonus/README_EN.md)
